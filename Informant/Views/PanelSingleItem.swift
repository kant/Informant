...
//				}
				...
				ComponentsPanelItemStack(
					firstLabel: ContentManager.Labels.panelKind,
					firstValue: selection!.itemKind,
					secondLabel: ContentManager.Labels.panelSize,
					secondValue: selection!.itemSizeAsString
				)
